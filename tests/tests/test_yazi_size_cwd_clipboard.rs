 ...
 * 3. Triggers the plugin using the keymap sequence (. + y)
 * 4. Verifies the plugin displays "Copied to clipboard" notification
 * 5. Verifies the clipboard contains the size information
 * 6. Quits Yazi
